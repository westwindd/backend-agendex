				...
				<tbody>
					...
					?>
						<tr>
							...
							<td>
                                <p class="m-0">
                                    <small><b>Start:</b> <?php echo date("Y M, d h:i A",strtotime($row['datetime_start'])) ?></small><br>
                                    <small><b>End:</b> <?php echo date("Y M, d h:i A",strtotime($row['datetime_end'])) ?></small>
                                </p>
                            </td>
